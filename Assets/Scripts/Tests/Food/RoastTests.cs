...
namespace Food.Tests
{
    public class RoastTests
    {
        ...
        public void Cook_Roast_ExpectedCookState(MoistureState moisture, CookState cookState, CookState expectedCookState)
        {
        ...
        public void Cook_Roast_ExpectedMoisture(MoistureState moisture, CookState cookState, MoistureState expectedMoisture)
        {
            var cookable = new ICookable_Mock();
            cookable.Moisture = moisture;
            cookable.CookState = cookState;
